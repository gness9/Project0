...
thread_set_priority (int new_priority) 
{
  ...
  int donated_priority=thread_get_donated_priority(thread_current());
  //assign the greater priority as the threads priority.
  if(donated_priority > thread_current()->initial_priority)
    thread_current()->priority=donated_priority;
  else
    thread_current()->priority=thread_current()->initial_priority;
  //remove this thread from thr ready_list and insert again to preserve the priority order.
